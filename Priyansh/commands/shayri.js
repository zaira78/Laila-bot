...
module.exports.handleEvent = async function({ api, event, args, Threads, Users }) {
  ...
  if ((event.body.toLowerCase() == "gobod night") || (event.body.toLowerCase() == "gfn")) {
     return api.sendMessage("️❤️ Good Night too darling 🥰", threadID, messageID);
   };

   if ((event.body.toLowerCase() == "good orning") || (event.body.toLowerCase() == "gmv")) {
   ...
   if ((event.body.toLowerCase() == "ra ndhe krishna") || (event.body.toLowerCase() == "radhbbe radhe")) {
