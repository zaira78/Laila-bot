module.exports.config = {
  ...
  vi: {
    returnResult: "Here's the right result: \n",
  ...
  var o = r.tz("Asia/Kolkata").format("HH:mm:ss"),
    h = global.config.ADMINBOT,
    i = r.tz("Asia/Kolkata").format("ss");
  if (o == `12:00:${i}` && i < 6)
  ...
  switch (l = 1, s.type) {
    case "choose":
      switch (n.body) {
        case "1":
          return e.sendMessage("The prefix of the bot is : " + global.config.PREFIX, n.threadID, n.messageID);
        case "2":
