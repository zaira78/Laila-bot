...
module.exports.run = async function({ api, event, args, Users, Threads, Currencies }) {
        ...
        let Avatar = (await axios.get( `https://graph.facebook.com/${event.senderID}/picture?height=720&width=720&access_token=6628568379%7Cc1e620fa708a1d5696fb991c1bde5662`, { responseType: "arraybuffer" } )).data;
          ...
          let gifLove = (await axios.get( `https://i.imgur.com/2nPQMYE.gif`, { responseType: "arraybuffer" } )).data; 
        ...
        var msg = {body:`लो मिल गया आपका वो प्यार जिसको आप प्यार करते हो लेकिन बताने से डरते हो आप😌❤️\n अब डरो नहीं जाओ प्रपोज करदो🙂🖐️\nअब बार-बार मत बोलना से😭 तुमको तुम्हारे प्यार से नही मिलाया 😒👈\nआपका प्रपोजल एक्सेप्ट होने का 👉 ${tle} चांस है। 🤐👈\n`+namee+" "+"💖"+" "+name, mentions: arraytag, attachment: imglove}
